...
3. If scope is L/XL, also create [PLAN] — see plan template below **If [AGENT_MEMORY] exists:**
4. Read `todos.md` and `insights.md` in full
5. Read `context.md` for scope and DoD
6. Determine current phase and first unchecked step
7. Continue from there — do NOT re-read full [SPEC]
...
4. If fatal: **STOP**, report blocker + what you need from the user
