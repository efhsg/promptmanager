...
$runClaudeUrl = Url::to(['/project/run-claude', 'id' => $model->id]);
$streamClaudeUrl = Url::to(['/project/stream-claude', 'id' => $model->id]);
$cancelClaudeUrl = Url::to(['/project/cancel-claude', 'id' => $model->id]);
$summarizeUrl = Url::to(['/project/summarize-session', 'id' => $model->id]);
$summarizePromptUrl = Url::to(['/project/summarize-prompt', 'id' => $model->id]);
...
$checkConfigUrl = Url::to(['/project/check-claude-config', 'id' => $model->id]);
$usageUrl = Url::to(['/project/claude-usage', 'id' => $model->id]);
        ...
        <div id="claudeSettingsCard" class="d-none">
            <div class="card-body claude-settings-section">
                ...
                <div class="mb-3" id="claude-settings-badges">
                    <span class="badge bg-secondary" title="Project"><i class="bi bi-folder2-open"></i> <?= Html::encode($model->name) ?></span>
                    <?php if ($gitBranch): ?>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <?= Html::dropDownList('project_id', $model->id, $projectList, [
...
$js = <<<JS
    (function() {
        // Load initial content from sessionStorage (set by prompt-instance create)
        ...
        // initialDelta was loaded from sessionStorage at the top
